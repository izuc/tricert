...
public class User extends BusinessModule implements Serializable {
    ...
    public static ResponseMessage doLogin(Map<String, String> formParameters, Map<String, FileItem> fileFields) throws IOException {
    ...
    protected PreparedStatement insert() throws SQLException {
        return Dal.doMutation(new Object[]{this.getGroupID(), this.getEmployeeID(), this.getUserName(), this.getPassword(), this.getUserType()}, User.SQL_INSERT);
    }

    @Override
    protected PreparedStatement update() throws SQLException {
        PreparedStatement update = Dal.doMutation(new Object[]{this.getGroupID(), this.getEmployeeID(), this.getUserName(), this.getUserType(), this.getUserID()}, User.SQL_UPDATE);
