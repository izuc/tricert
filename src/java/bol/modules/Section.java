...
public class Section extends BusinessModule implements Serializable {
    ...
    protected PreparedStatement insert() throws SQLException {
        return Dal.doMutation(new Object[]{this.getModuleID(), this.getGroupID(), this.getCategoryID()}, Section.SQL_INSERT);
    }

    @Override
    protected PreparedStatement update() throws SQLException {
        return Dal.doMutation(new Object[]{this.getModuleID(), this.getGroupID(), this.getCategoryID(), this.getSectionID()}, Section.SQL_UPDATE);
    }

    public static ArrayList<BusinessModule> grantedSections(AccessGroup group, int categoryID) {
        return (ArrayList<BusinessModule>) Socket.<BusinessModule>list(new Object[]{group.getGroupID(), categoryID}, Section.SQL_GRANTED_SECTION_LIST, Section.class, Dal.StatmentType.preparedStatment);
    }
